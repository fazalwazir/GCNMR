...
def load_data(dataset_str, path=""):
    ...
    features = sio.loadmat(path + "feat.mat")
    features = features['feat']
    adj = sio.loadmat(path + "adj.mat")
    adj = adj['adj']
    labels = sio.loadmat(path + "label.mat")
    labels = labels['label']
    trainmask = sio.loadmat(path + dataset_str + "trid.mat")
    idx_train = trainmask['train_idx']
    valmask = sio.loadmat(path + dataset_str + "vaid.mat")
    idx_val = valmask['valid_idx']
    testmask = sio.loadmat(path + dataset_str + "teid.mat")
